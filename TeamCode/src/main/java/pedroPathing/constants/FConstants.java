...
public class FConstants {
    static { // 13.7:1 gear ratio
        ...
        FollowerConstants.drivePIDFCoefficients.setCoefficients(1.0, 0, 0.05, 0.6, 0);
        FollowerConstants.useSecondaryDrivePID = true;
        FollowerConstants.drivePIDFSwitch = 28;
        FollowerConstants.secondaryDrivePIDFCoefficients.setCoefficients(0.01, 0, 0.00005, 0.6, 0);
