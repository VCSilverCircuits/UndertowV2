package vcsc.teamcode.opmodes.tele.tele;
...
@TeleOp(name = "[EMERGENCY] Safe Mode Tele", group = "Main")
public class SafeModeTele extends BaseOpMode {
    ...
    public void loop() {
        ...
        A_SetArmExtensionPower setPower = new A_SetArmExtensionPower(-(gamepad2.left_stick_y + gamepad1.left_stick_y));
        TaskManager.getInstance().runTask(setPower);
