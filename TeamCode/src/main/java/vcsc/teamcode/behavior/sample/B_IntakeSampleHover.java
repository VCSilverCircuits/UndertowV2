...
public class B_IntakeSampleHover extends Behavior {
    TaskSequence _taskSequence;

    public B_IntakeSampleHover() {
        super();
        ...
        A_SetElbowGlobalPose elbowOut = new A_SetElbowGlobalPose(GlobalPose.INTAKE_SAMPLE_HOVER);
        A_SetWristHingeGlobalPose hingeBack = new A_SetWristHingeGlobalPose(GlobalPose.INTAKE_SAMPLE_HOVER);
        A_SetWristTwistGlobalPose twist = new A_SetWristTwistGlobalPose(GlobalPose.INTAKE_SAMPLE_HOVER);
        A_SetClawGlobalPose clawOpen = new A_SetClawGlobalPose(GlobalPose.INTAKE_SAMPLE_HOVER);

        A_SetArmExtensionGlobalPose extendSlides = new A_SetArmExtensionGlobalPose(GlobalPose.INTAKE_SAMPLE_HOVER);
        A_SetArmRotationGlobalPose rotateArmBack = new A_SetArmRotationGlobalPose(GlobalPose.INTAKE_SAMPLE_HOVER);
