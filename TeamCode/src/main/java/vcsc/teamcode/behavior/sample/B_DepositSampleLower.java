...
public class B_DepositSampleLower extends Behavior {
    ...
    public B_DepositSampleLower() {
        ...
        A_SetElbowGlobalPose elbowOut = new A_SetElbowGlobalPose(GlobalPose.DEPOSIT_SAMPLE_LOWER);
        A_SetWristHingeGlobalPose hingeBack = new A_SetWristHingeGlobalPose(GlobalPose.DEPOSIT_SAMPLE_LOWER);
        A_SetWristTwistGlobalPose twist = new A_SetWristTwistGlobalPose(GlobalPose.DEPOSIT_SAMPLE_LOWER);

        A_SetArmExtensionGlobalPose extendSlides = new A_SetArmExtensionGlobalPose(GlobalPose.DEPOSIT_SAMPLE_LOWER);
        A_SetArmRotationGlobalPose rotateArmBack = new A_SetArmRotationGlobalPose(GlobalPose.DEPOSIT_SAMPLE_LOWER);
